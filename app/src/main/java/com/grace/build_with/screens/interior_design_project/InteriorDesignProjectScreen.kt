package com.grace.build_with.screens.interior_design_project
...
val contentList = listOf(
    ...
    Content(0,"Area cover for the project?", LOREM_TEXT),
    Content(0,"How large is the space?", LOREM_TEXT),
    Content(0,"What is your residence standard?", LOREM_TEXT),
)
...
@Composable
fun InteriorDesignProjectScreen(navController: NavHostController) {
...
@Composable
fun InteriorDesignProjectScreenPreview() {
    InteriorDesignProjectScreen(rememberNavController())
}
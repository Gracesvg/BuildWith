package com.grace.build_with.screens.renovation_project
...
val contentList = listOf(
    ...
    Content(0,"Rooms under renovation?", LOREM_TEXT),
    Content(0,"Size of the space for renovation?", LOREM_TEXT),
    Content(0,"When was the last renovation?", LOREM_TEXT),
)
@Composable
fun ExpandableCard(
    content: Content,
...
@Composable
fun RenovationProjectScreen(navController: NavHostController) {
...
@Composable
fun RenovationProjectScreenPreview() {
    RenovationProjectScreen(rememberNavController())
}
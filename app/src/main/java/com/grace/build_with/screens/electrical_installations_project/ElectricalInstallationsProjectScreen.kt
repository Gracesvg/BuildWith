package com.grace.build_with.screens.electrical_installations_project
...
@Composable
fun ElectricalInstallationsProjectScreen(navController: NavHostController) {
...
@Composable
fun ElectricalInstallationsProjectScreenPreview() {
    ElectricalInstallationsProjectScreen(rememberNavController())
}

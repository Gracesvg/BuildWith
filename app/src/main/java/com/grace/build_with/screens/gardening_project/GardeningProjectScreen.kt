package com.grace.build_with.screens.gardening_project
...
val contentList = listOf(
    ...
    Content(0,"How big is the garden?", LOREM_TEXT),
    Content(0,"Style preference for the garden?", LOREM_TEXT),
)
...
@Composable
fun GardeningProjectScreen(navController: NavHostController) {
...
@Composable
fun GardeningProjectScreenPreview() {
    GardeningProjectScreen(rememberNavController())
}
package com.grace.build_with.screens.kitchen_planning_project
...
val contentList = listOf(
    ...
    Content(0,"What kind of design is your kitchen?", LOREM_TEXT),
    Content(0,"What is your design preference?", LOREM_TEXT),
    Content(0,"What kind of hob interests you?", LOREM_TEXT),
    Content(0,"Work-top materials of your choice?", LOREM_TEXT),
)
@Composable
fun ExpandableCard(
    content: Content,
...
@Composable
fun KitchenPlanningProjectScreen(navController: NavHostController) {
...
@Composable
fun KitchenPlanningProjectScreenPreview() {
    KitchenPlanningProjectScreen(rememberNavController())
}
package com.grace.build_with.screens.tile_work_project
...
val contentList = listOf(
    ...
    Content(0,"What kind of real estate is it?", LOREM_TEXT),
    Content(0,"Which rooms should be tiled?", LOREM_TEXT),
    Content(0,"Size of the area to be tiled?", LOREM_TEXT),
    Content(0,"Type of tiles to be installed?", LOREM_TEXT),
)
...
@Composable
fun TileWorkProjectScreen(navController: NavHostController) {
...
@Composable
fun TileWorkProjectScreenScreenPreview() {
    TileWorkProjectScreen(rememberNavController())
}
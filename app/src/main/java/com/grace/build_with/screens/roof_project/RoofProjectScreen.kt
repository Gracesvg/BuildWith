package com.grace.build_with.screens.roof_project
...
val contentList = listOf(
    ...
    Content(0,"What shape is the roof?", LOREM_TEXT),
)
@Composable
fun ExpandableCard(
    content: Content,
...
@Composable
fun RoofProjectScreen(navController: NavHostController) {
...
@Composable
fun RoofProjectScreenPreview() {
    RoofProjectScreen(rememberNavController())
}
package com.grace.build_with.screens.floor_work_project
...
val contentList = listOf(
    ...
    Content(0,"Types of flooring installations?", LOREM_TEXT),
    Content(0,"Underfloor heating inclusion?", LOREM_TEXT),
   )
...
@Composable
fun FloorWorkProjectScreen(navController: NavHostController) {
...
@Composable
fun FloorWorkProjectScreenPreview() {
    FloorWorkProjectScreen(rememberNavController())
}
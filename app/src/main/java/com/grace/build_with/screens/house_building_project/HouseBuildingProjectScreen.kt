package com.grace.build_with.screens.house_building_project
...
val contentList = listOf(
    ...
    Content(0,"Size of area to be covered?", LOREM_TEXT),
    Content(0,"Size of your living space ?", LOREM_TEXT),
    Content(0,"What is your design preference?", LOREM_TEXT),
    Content(0,"Construction type preference?", LOREM_TEXT),
)
...
@Composable
fun HouseBuildingProjectScreen(navController: NavHostController) {
...
@Composable
fun HouseBuildingProjectScreenPreview() {
    HouseBuildingProjectScreen(rememberNavController())
}
package com.grace.build_with.screens.furniture_design_project
...
val contentList = listOf(
    ...
    Content(0,"Furniture installation preferences?", LOREM_TEXT),
   )
...
@Composable
fun FurnitureDesignProjectScreen(navController: NavHostController) {
...
@Composable
fun FurnitureDesignProjectScreenPreview() {
    FurnitureDesignProjectScreen(rememberNavController())
}
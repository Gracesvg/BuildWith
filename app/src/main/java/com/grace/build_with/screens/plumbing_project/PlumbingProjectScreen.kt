package com.grace.build_with.screens.plumbing_project
...
val contentList = listOf(
    ...
    Content(0,"What should be worked on?", LOREM_TEXT),
    )
@Composable
fun ExpandableCard(
    content: Content,
...
@Composable
fun PlumbingProjectScreen(navController: NavHostController) {
...
@Composable
fun PlumbingProjectScreenPreview() {
    PlumbingProjectScreen(rememberNavController())
}